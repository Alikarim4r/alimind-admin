...
## ماك بوك (تطبيق سطح مكتب)

مجلد `macos/` غير موجود في المستودع، ويُولَّد مرة واحدة. استخدم السكربت
الجاهز — يولّد الملفات ويضيف إذن الموقع ومفاتيح الـ sandbox تلقائياً:
...
اسحب `arabic_temporal_watch.app` إلى مجلد **Applications**.

عند أول تشغيل قد يعترض Gatekeeper لأن التطبيق غير موقّع بشهادة مطوّر:
اضغط بزر الفأرة الأيمن على التطبيق ← **Open** ← **Open** مرة أخرى.

### ما يعمل وما لا يعمل على الماك

| الميزة | الحالة |
|--------|--------|
| وجه الساعة والحلقة الزمنية والحسابات الفلكية | ✅ كامل |
| تحديد الموقع (CoreLocation) | ✅ بعد الموافقة على الإذن |
| صوت الأذان | ✅ |
| الاهتزاز | ➖ غير موجود على الماك |
| إسكات الأذان بالهز | ➖ لا يوجد مقياس تسارع — أسكته باللمس |
| فتح إعدادات النظام تلقائياً | ➖ افتحها يدوياً: الإعدادات ← الخصوصية والأمان ← خدمات الموقع |

هذه الفروق مُعالَجة في الكود: التطبيق يكتشف المنصة ويتخطى الإضافات غير
المدعومة بدل أن ينهار.
